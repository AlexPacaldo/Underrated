...
export default function ProductDetailView({ product, onAdd, topOffset = true, backHref = "/shop", backLabel = "Back to index" }: { product: Product; onAdd?: (product: Product, finish: string, quantity: number) => void; topOffset?: boolean; backHref?: string; backLabel?: string }) {
