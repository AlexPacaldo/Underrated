...
function ProductEditor({ product, onSaved, onCancel }: { product: Product; onSaved: () => Promise<void>; onCancel: () => void }) {
  ...
  // Fit shrinks the proof to the column; 100% keeps the storefront's real type size and lets the frame pan.
  const frameScale = zoom === "actual" ? 1 : scale;
