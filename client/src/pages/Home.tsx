  ...
  return (
    <>
      <section className="relative min-h-[790px] overflow-hidden bg-[#090a0b] pt-[68px] sm:min-h-[850px]">
        <img src={homepage.hero_image_path} alt={homepage.hero_alt} className="absolute inset-0 h-full w-full object-cover object-[62%_center]" />
        ...
        <div className="relative mx-auto flex min-h-[722px] max-w-[1440px] flex-col justify-end px-4 pb-8 pt-20 sm:px-6 sm:pb-10 lg:min-h-[782px] lg:px-9">
          <div className="max-w-[680px]">
            <p className="reveal-up text-[10px] font-bold uppercase tracking-[.2em] text-[#ff5a36]">{homepage.hero_kicker}</p>
            <h1 className="reveal-up mt-4 font-display text-[clamp(5rem,11vw,10.6rem)] uppercase leading-[.68] tracking-[-.065em] text-white">{homepage.hero_title}<br /><em className="text-[#ff5a36]">{homepage.hero_accent}</em><br />{homepage.hero_suffix}</h1>
            <p className="reveal-up mt-7 max-w-sm text-sm leading-6 text-white/64 sm:text-base">{homepage.hero_description}</p>
